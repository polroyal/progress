...
if (isset($_POST['submit'])){
	...
	if ($username && $password){
		$query = "SELECT * FROM users WHERE pj like '$username' OR email like '$username'";
		echo "$query";
		$result_users = mysqli_query($GLOBALS['conn'], $query);
	...
	<div class="wrapper">
		<form action="" method="post" name="Login_Form" class="form-signin">       
		    <h3 class="form-signin-heading">Welcome Back! Please Sign In</h3>
			  ...
			  <input type="text" class="form-control" name="username" placeholder="PJ OR Email" required="" autofocus="" />
