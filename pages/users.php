    ...
    <div class="col-lg-12">
        ...
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" action="index.php?p=users" method="post" accept-charset="utf-8" id="frmLeaveForm">
                  ...
                  <!--   <div class="form-group">
                        ...
                        <div class="col-sm-9">
							<div class="col-md-11 xdisplay_inputx form-group has-feedback">
								<input class="form-control has-feedback-left" id="single_cal2" placeholder="" aria-describedby="inputSuccess2Status2"type="text" name="date_of_birth"/>
         	...
         	<!-- <div class="form-group">
                        <label for="date_of_birth" class="col-sm-3 control-label">Date Transfered:</label>
                        <div class="col-sm-9">
                    
        
            <div class="col-md-11 xdisplay_inputx form-group has-feedback">
             <input class="form-control has-feedback-left" id="single_cal3" placeholder="First Name" aria-describedby="inputSuccess2Status2" type="text" name="date_transfered">
                          <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                           <span id="inputSuccess2Status2" class="sr-only">(success)</span>
                           </div>
 ...
 -->
    <!-- <table id="datatable-fixed-header" class="table table-striped table-bordered">
            ...
            <tbody> 
                ...
                <?php
                $query = "SELECT * from usersv WHERE true AND Designation NOT LIKE 'Admin' ";
				if (strtolower($_SESSION['leave_group']) != "admin"){
					$query .= " AND pj like '$_SESSION[leave_pj]'";
				}
