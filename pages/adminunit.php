                  ...
                  <div class="x_content">
                    ...
                    <form id="frmLeaveForm" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post" accept-charset="utf-8">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="fullname" class="form-control col-md-7 col-xs-12" type="text" name="admin_unit">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button a href ="" type="submit" name="submit" class="btn btn-success">Save Admin Unit </a> </button>
                        </div>
                      </div>
